...
export function ContactSection() {
  ...
  const handleOnSubmit = (e) => {
    ...
    emailjs.sendForm('service_9cueyyn', 'template_2wvulqr', e.target, 'r3dmV8WFrrxwAlsTS').then(
      (result) => {
  ...
  return (
    <div className={styles.rootCont} id="contact" style={{ scrollMarginTop: "80px", paddingTop: "30px", boxSizing: "border-box" }}>
      <Fade bottom>
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="mailto:antaraburman888@gmail.com">
        ...
        <p className={styles.text}>Phone: +91 9382070724</p>{" "}
        <p className={styles.text}>Email:antaraburman888@gmail.com</p>
      </Fade>
    </div>
  )
}
